...
>
    ...
    @else
        <button {{ $attributes->except('class') }} class="flex items-center space-x-1 text-center text-md leading-4 font-semibold text-cool-gray-500 tracking-wider group focus:outline-none focus:underline">
            <span>{{ $slot }}</span>
