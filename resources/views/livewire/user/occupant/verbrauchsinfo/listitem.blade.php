<div class="">
    <div
        class="hidden md:flex pt-1 text-lg text-center dark:text-slate-300
    ...
    <div class= "max-w-sm pb-4 m-1 sm:hidden dark:text-slate-200">
        <div
            class="text-sm font-bold text-center border rounded-t-lg sm:flex-1 bg-sky-100 dark:bg-slate-800 border-sky-100 dark:border-slate-950 basis-1/6">
            <div class="flex justify-center basis-1/2">
                <x-table.heading class="items-center text-sm text-center " sortable multi-column
                    wire:click="sortBy('datum')" :direction="$sorts['datum'] ?? null">
        ...
        <div class="text-sm border rounded-b-lg border-sky-100 dark:border-slate-950">
            ...
            <div class="flex justify-around pb-1 mt-1">
                <div class="flex text-lg font-bold text-center basis-1/6">
                    <span
                        class="{{ $singleVerbrauchsinfo->ww ? 'text-red-800 dark:text-red-400 ' : 'text-green-600 ' }}">
                        {{ $singleVerbrauchsinfo->VerbrauchAktDisplay }}
                    </span>
                    <span
                        class="{{ $singleVerbrauchsinfo->ww ? 'text-red-800 dark:text-red-400 ' : 'text-green-600 ' }}">
