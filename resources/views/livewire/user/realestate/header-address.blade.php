<div>
    <div class="hidden sm:block rounded-md">
        ...
        <x-input.select
        class="text-left h-10 border-b bg-sky-200 dark:bg-slate-800 sm:h-8 dark:focus:border-slate-800 focus:border-0 w-full" wire:model.live="realestate.abrechnungssetting_id" id="realestate-header-address-abrechnungssetting-id" value="">
